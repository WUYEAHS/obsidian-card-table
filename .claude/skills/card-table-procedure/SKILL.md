...
- Windows:`C:\Users\新春\Documents\Cintrun3\0.常用\Card table project\0.Procedure\Working procedure.md`
- Mac:`/Users/wujiajun/Documents/Cintrun3/0.常用/Card table project/0.Procedure/Working procedure.md`
- 範本:`0.Procedure/Templates/`。2026-09-24 起正本是 v0.2 短版;舊版和 `Roles.md` 在 `0.Procedure/archive/`(要查再翻)。
- **開工順序**:`Handoff.md`(專案資料夾最上層)→ `Working procedure.md`。
...
**平常的溝通像 Discord**(使用者明講):每做一件事,在 `Dialogue/Dev chat.md` 最下面留一兩句(發現、做了什麼、需要使用者什麼)。
...
- `Dialogue/Dev chat.md`:平常的短訊息,最新的在最下面。
